      ...
      map.addLayer({
        ...
        paint: {
          "circle-radius": [
            ...
            ["get", "mass"],
            10,
            2, // for mass = 10, radius = 2
            100,
            4, // for mass = 100, radius = 4
            500,
            8, // for mass = 500, radius = 8
            1000,
            12, // for mass = 1000, radius = 12
            10000,
            20, // for mass = 10000, radius = 20
            100000,
            28, // for mass = 100000, radius = 28
            500000,
            36, // for mass = 500000, radius = 36
            1000000,
            48, // for mass = 1000000, radius = 48
            2000000,
            60, // for mass = 2000000, radius = 60
            4000000,
            72, // for mass = 4000000, radius = 72
            10000000,
            88, // for mass = 10000000, radius = 88
          ],
          "circle-color": "#f04800",
